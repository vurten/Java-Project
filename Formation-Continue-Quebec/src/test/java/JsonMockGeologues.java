...
public class JsonMockGeologues extends JsonClass{

    protected JSONObject objetJson;

    public JsonMockGeologues(String numero_de_permis,String ordre,String prenom
            ,String nom,int sexe,String cycle) {
        super();
        this.tabloActivites = activiteArchitecte();
        this.objetJson = retournerUnJSONObject( numero_de_permis, ordre, prenom, nom, sexe, cycle);
    ...
    public JSONArray activiteArchitecte() {
        ...
        activite.accumulate("date","2019-01-22");
        activites_json.add(activite);
        ...
        activite.accumulate("date","2019-05-20");
        activites_json.add(activite);
