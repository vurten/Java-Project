...
public class JsonMockPsychologues extends JsonClass{

    protected JSONObject objetJson;

    public JsonMockPsychologues(String numero_de_permis,String ordre,String prenom
